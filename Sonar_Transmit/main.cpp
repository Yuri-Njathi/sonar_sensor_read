...
static const int STANDBY_TIME_S = 20;  // standby time in seconds
...
static void send_message() {
    ...
    while (attempt++ < SENSOR_READ_ATTEMPTS) {
      error_code = Sonar.readData(); //temperature_humidity_sensor.readData();
